...
class Match extends Component {
  ...
  render() {
    ...
    if (game.type === 'group') {
      ...
      return (<KnockoutMatch game={game} pool = {this.props.pool} chooseDrawWinnerHandler={this.props.chooseDrawWinnerHandler} handleChangedResult={this.props.handleChangedResult}/>)
    }
  }
}
